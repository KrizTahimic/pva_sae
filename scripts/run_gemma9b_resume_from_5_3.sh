#!/bin/bash
# Resume Gemma-2-9B pipeline from Phase 5.3 onward.
# Stages 1-4 (phases 1 → 6.3) already completed successfully.
#
# Usage:
#   screen -S gemma9b
#   bash scripts/run_gemma9b_resume_from_5_3.sh

set -e

LOG_FILE="scripts/gemma9b_resume_from_5_3.log"
...
echo "============================================================"
echo "Gemma-2-9B Resume from Phase 5.3"
echo "Started: $(date)"
