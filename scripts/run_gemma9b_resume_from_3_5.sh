#!/bin/bash
# Resume script:
#   1. Fix Gemma-2-2B Phase 3.5/3.10/3.11 (temperature sweep was incomplete)
#   2. Resume Gemma-2-9B from Phase 3.5 onwards
#
# Usage:
#   screen -S gemma9b
#   bash scripts/run_gemma9b_resume_from_3_5.sh
...
# Patch config for Gemma 9B instruct (restored on exit)
...
echo "============================================================"
echo "Gemma-2-9B Resume from Phase 3.5 (+ 2B temperature fix)"
echo "Started: $(date)"
...
# ============================================================
# FIX: Gemma-2-2B Phase 3.5/3.10/3.11 (missing temperatures)
# ============================================================
echo ""
echo "############ FIX: Gemma-2-2B Temperature Phases ############"

run_phase "Phase 3.5: 2B temperature robustness (full sweep)" \
    phase 3.5 --parallel 4

run_phase "Phase 3.10: 2B temperature-based AUROC" \
    phase 3.10

run_phase "Phase 3.11: 2B temperature trends visualization" \
    phase 3.11

# ============================================================
# STAGE 3: Statistical Validation (SAE) — Gemma-2-9B
# ============================================================
echo ""
echo "############ STAGE 3: Statistical Validation (SAE) — 9B ############"

run_phase "Phase 3.5: Temperature robustness (full sweep)" \
