...
\begin{itemize}
    ...
    \item \textbf{Control}: Random feature from a different layer with zero separation score, following \citeA{ferrando2024know}. We use the same steering coefficients $\alpha$ as the corresponding steering direction to isolate the effect of feature selection from coefficient magnitude
