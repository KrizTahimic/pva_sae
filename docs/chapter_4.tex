...
\end{minted}
\end{minipage}
\caption{Successful incorrect-steering examples (correct→incorrect). Both cases show the characteristic pattern of incorrect-steering: replacing correct logic with '8' tokens or variants.}
...
\end{minted}
\end{minipage}
\caption{Examples of initially correct code that became incorrect after correct-steering intervention.}
