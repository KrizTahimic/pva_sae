...
def run_phase4_16(config: Config, logger, device: str):
    """Run Phase 4.16: Difficulty-Stratified Steering Analysis"""
    from phase4_16_difficulty_steering.difficulty_steering_analyzer import main

    logger.info("Starting Phase 4.16: Difficulty-Stratified Steering Analysis")
    logger.info("Analyzing whether problem difficulty affects steering success rates")
    logger.info("Uses chi-square tests to determine statistical significance")

    # Log configuration
    logger.info("\n" + config.dump(phase="4.16"))

    # Run the analysis
    main()

    logger.info("\n✅ Phase 4.16 completed successfully")
