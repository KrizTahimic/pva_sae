...
def setup_argument_parser():
    ...
    phase0_group = parser.add_argument_group('Phase 0: Difficulty Analysis')
    ...
    phase1_group = parser.add_argument_group('Phase 1: Dataset Building')
    ...
    phase2_group = parser.add_argument_group('Phase 2: SAE Analysis')
    ...
    phase3_group = parser.add_argument_group('Phase 3: Validation')
