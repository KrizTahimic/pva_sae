...
class InstructBaselineRunner:
    ...
    def run(self) -> dict[str, any]:
        ...
        # Initialize current batch tracking
        ...
        for idx, row in tqdm_with_logging(analysis_data.iterrows(), logger, total=len(analysis_data), desc="Instruction-tuned baseline generation"):
            ...
            if memory_percent > 95:
                ...
                self.checkpoint_mgr.save_parquet(results_df, current_processed, current_excluded, all_excluded + excluded_tasks)
            ...
            if self.checkpoint_mgr.should_save(tasks_since_checkpoint, memory_percent) and results:
                # Add to all results
